...
const ReportsUserForDist = ({ tokenProp }) => {
  const token = tokenProp || localStorage.getItem("distributorToken");
  ...
  const handleClick = async () => {
    try {
      ...
      const response = await axios.post(
        "https://api.manomilan.com/api/distributor/reports",
        payload,
        {
...
export default ReportsUserForDist;