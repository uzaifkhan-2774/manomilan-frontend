...
const MatrimonyCards = ({ matches, token,subscribeIds }) => {
  ...
  const ProfileCard = ({ profile }) => (
    ...
    >
      <div className="relative">
        <img
          src={profile.userPhotoStatus === "Approved" ? `http://localhost:8000/upload/${profile.userPhotoOne}`:"https://imgs.search.brave.com/rwE-hC6ESt3hBJZhImPkb-KvU26bLDKVe-OKv1y50-M/rs:fit:860:0:0:0/g:ce/aHR0cHM6Ly9pLnBp/bmltZy5jb20vb3Jp/Z2luYWxzLzE0LzQz/LzU1LzE0NDM1NWQ3/YjM2YzVmNjQ2NDM1/NDIzNzk4MjgxY2U5/LmpwZw"}
          alt={profile.name}
  ...
  try {
    const response = await axios.post(
      "http://localhost:8000/api/user/subscribe",
      {
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 p-6">
              ...
              <div className="bg-gradient-to-b from-[#7d0a0a] to-[#a01a1a] text-white rounded-lg p-6 mb-6">
                <div className="text-center mb-4">
                  <div className="w-32 h-40 mx-auto mb-4 bg-gray-300 rounded-lg overflow-hidden">
                    <img
                      src={selectedProfile.userPhotoStatus==="Approved"? `http://localhost:8000/upload/${selectedProfile.userPhotoOne}` : image}
                      alt="Profile"
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="bg-[#7d0a0a]/10 rounded-lg p-4">
                ...
                {/* blank for unpaid members */}
                {
                  subscribeIds ? (
                    ...
                    <p>This info is visible to subscription paid members only</p>
                  )
                }
              </div>
              ...
              <div className="bg-[#7d0a0a]/10 rounded-lg p-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 text-sm">
                  {/* <div>
                  <span className="font-medium">Native Village:</span>{" "}
                  {selectedProfile.nativeLocation}
                </div> */}
                  <div>
