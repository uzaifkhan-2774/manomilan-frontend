...
const ProfileDashboard = () => {
  ...
  const getFranchiseAndDistributor = async () => {
    try {
      ...
      const response = await axios.get(
        `http://localhost:8000/api/user/get-franchise-distributor/${currUser.franchiseUnder}`,
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  try {
    ...
    const response = await axios.get(
      "http://localhost:8000/api/user/mutual-matching",
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
...
useEffect(() => {
  ...
  const getSentMessages = async () => {
    try {
      const response = await axios.get(
        "http://localhost:8000/api/user/message/get-sendMessages",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  const getInboxMessages = async () => {
    try {
      const response = await axios.get(
        "http://localhost:8000/api/user/message/replies",
        {
          headers: {
            Authorization: `Bearer ${token}`,
          },
  ...
  try {
    const response = await axios.get(
      "http://localhost:8000/api/user/getSubscribes",
      {
        headers: {
          Authorization: `Bearer ${token}`,
        },
  ...
  const packagesAvailable = async (userId) => {
    try {
      const response = await axios.get(
        `http://localhost:8000/api/user/get-packages/${userId}`
      );
      console.log(response.data)
      if (response.data.status) {
  ...
  const changeEmail = async (id) => {
    try {
      const response = await axios.put(
        ...
        "http://localhost:8000/api/user/change-user-email",
        {
