...
const CountrySettings = () => {
    ...
    const addCountry = async () => {
        if (countryInput.trim()) {
            ...
            try {
                ...
                const response = await axios.post('http://127.0.0.1:8000/api/admin/add-country', mappedData)
    ...
    const DeleteCountry = async (country) => {
        try {
            const response = await axios.delete('http://127.0.0.1:8000/api/admin/delete-country', { data: { country } })
    ...
    const addState = async () => {
        if (stateInput.trim() && selectedCountryForState) {
            ...
            try {
                ...
                const response = await axios.post('http://127.0.0.1:8000/api/admin/add-state-country', mappedData)
    ...
    const handleDelete = async (state, country) => {
        try {
            const response = await axios.delete('http://127.0.0.1:8000/api/admin/delete-state-country', { data: { state, country } })
            if (response.status === 200) {
                alert(response.data.message)
    ...
    const addCity = async () => {
        if (cityInput.trim() && selectedCountryForCity && selectedStateForCity) {
            ...
            try {
                const response = await axios.post('http://127.0.0.1:8000/api/admin/add-state-city', mappedData)
    ...
    const deleteCity= async (city,state,country)=>{
        try {
            const response = await axios.delete('http://127.0.0.1:8000/api/admin/delete-city', { data: { state, country,city } })
            alert(response.data.message)
            await viewCountries()
            await viewStates()
            await viewCity()
