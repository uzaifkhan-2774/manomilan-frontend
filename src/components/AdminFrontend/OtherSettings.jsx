...
const UserPreferencesManager = () => {
  ...
  const getFoodPref = async () => {
    try {
      const response = await axios.get(
        "http://127.0.0.1:8000/api/admin/get-foodPref"
      );
      const fetched = response.data.result.map((item) => ({
        id: Date.now(),
  ...
  const getManglik = async () => {
    try {
      const response = await axios.get(
        "http://127.0.0.1:8000/api/admin/get-manglik"
      );
      if (response.data.status === true) {
        const fetched = response.data.result.map((item) => ({
          id: Date.now(),
  ...
  const getComplexion = async () => {
    try {
      const response = await axios.get(
        "http://127.0.0.1:8000/api/admin/get-complexion"
      );
      if (response.data.status === true) {
        const fetched = response.data.result.map((item) => ({
          id: Date.now(),
  ...
  const getBodyType = async () => {
    try {
      const response = await axios.get(
        "http://127.0.0.1:8000/api/admin/get-bodytype"
      );
      if (response.data.status === true) {
        const fetched = response.data.result.map((item) => ({
          id: Date.now(),
  ...
  const getPosition = async () => {
    try {
      const response = await axios.get(
        "http://127.0.0.1:8000/api/admin/get-position"
      );
      if (response.data.status === true) {
        const fetched = response.data.result.map((item) => ({
          id: Date.now(),
  ...
  const getFamBg = async () => {
    try {
      const response = await axios.get(
        "http://127.0.0.1:8000/api/admin/get-familybg"
      );
      if (response.data.status === true) {
        const fetched = response.data.result.map((item) => ({
          id: Date.now(),
  ...
  const addFoodPreference = async () => {
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/api/admin/add-foodPref",
  ...
  const addSect = async () => {
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/api/admin/add-sect",
        { sect: sectInput }
      );
      if (response.data.status === true) {
        toast.success(response.data.message);
  ...
  const addManglik = async () => {
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/api/admin/add-manglik",
  ...
  const addComplexion = async () => {
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/api/admin/add-complexion",
  ...
  const addBodyType = async () => {
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/api/admin/add-bodytype",
  ...
  const addFamilyBackground = async () => {
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/api/admin/add-familybg",
  ...
  const addPosition = async () => {
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/api/admin/add-position",
  ...
  const addMotherTongue = async () => {
    try {
      const response = await axios.post(
        "http://127.0.0.1:8000/api/admin/add-mother-tongue",
