...
export default function ManomilanLogin() {
  ...
  return (
    <div className="min-h-screen bg-gray-50 relative">
      ...
      <div
        className={`shadow-xl w-[50%] md:w-[15%] p-4 fixed top-17 left-4 bg-white rounded-lg z-50
      ...
      {/* Main Content */}
      {/* Added bigger bottom padding for mobile */}
      <div className="flex flex-col items-center px-4 pb-56 md:pb-32">
        {/* Logo */}
        ...
        <div className="w-full max-w-md space-y-6 relative z-10">
          ...
          <div className="flex items-center justify-between pt-4">
            <button
              ...
              className="text-blue-600 font-semibold border-0 hover:text-blue-700 text-md cursor-pointer relative z-20"
            >
              Forgot Password?
            </button>
      ...
      {/* Added lower z-index */}
      <div className="fixed bottom-0 left-0 right-0 bg-gray-50 px-4 pb-6 z-0">
        {/* Register Button */}
